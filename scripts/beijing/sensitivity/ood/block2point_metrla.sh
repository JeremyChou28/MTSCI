...
cuda='cuda:0'
seed=5
checkpoint_path='../saved_models/test/METR-LA/block/0.2/model_2024-05-04-12-00-58.pth'
...
do
    ...
    nohup python -u $python_script \
        ...
        > $folder_path/${method}_${dataset}_block2${missing_pattern}_valms${val_miss_ratio}_seed${seed}_${version}.log 2>&1 &
    wait
