...
cuda='cuda:0'
seed=5
checkpoint_path='../saved_models/test/Weather/point/0.2/model_2024-05-05-09-14-06.pth'
folder_path="../logs/miss_pattern_ood"
...
do
    ...
    nohup python -u $python_script \
        ...
        > $folder_path/${method}_${dataset}_point2${missing_pattern}_valms${val_miss_ratio}_seed${seed}_${version}.log 2>&1 &
    wait
